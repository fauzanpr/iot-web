<div class="relative z-10 hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true" id="modal-add-value-vertical">
    <!--
            ...
            <div
                ...
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    ...
                    <div>
                        ...
                        <input type="number" id="vertical" placeholder="Input Vertical Value" class="block p-2 border w-full rounded-lg placeholder:font-light placeholder:italic">
                    </div>
                </div>
